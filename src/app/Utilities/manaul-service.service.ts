...
export class ManaulServiceService {
  ...
  addCollege(payload: any) {
    return this.http.post(`${baseUrl}/auth/categories/add`, payload, {
      headers: { 'Content-Type': 'application/json' }
    });
  }

  deleteCollege(collegeId: number) {
    // const payload = { collegeId }; 
    return this.http.delete(`${baseUrl}/auth/categories/deleteCategoryById/${collegeId}`);
  }

  updateCollege(payload: any): Observable<any> {
    return this.http.put(`${baseUrl}/auth/categories/upateCategory`, payload, {
      headers: { 'Content-Type': 'application/json' }
    });
  }

  getCollegeById(collegeId: number) {
    return this.http.get(`${baseUrl}/auth/getCategoryById/${collegeId}`)
  }
  ...
  addBiodata(payload: any) {
    return this.http.post(`${baseUrl}/auth/biodata/addBiodata`, payload, {
      headers: { 'Content-Type': 'application/json' }
    });
  }
  ...
  updateBiodata(payload: any): Observable<any> {
    return this.http.put(`${baseUrl}/auth/biodata/${payload.id}`, payload, {
      headers: { 'Content-Type': 'application/json' }
    });
  }
}
